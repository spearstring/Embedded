...
int main(void)
{
	...
	TCCR1A |= 0x0A; //(1 << COM1C1) | (1 << WGM10);					// COM1C(1:0)="10", OC1C핀사용, WGM3(1:0)="10"
	TCCR1B |= 0x19; //(1 << WGM13) | (1 << WGM12) | (1 << CS10);	// WGM3(3:2)="11", CS3(2:0)="001" 1분주 사용
